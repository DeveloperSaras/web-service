 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://sks.com", wsdlLocation = "file:/C:/Users/saras/Desktop/wsdl/StudentService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://sks.com", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            //url = new URL("file:/C:/Users/saras/Desktop/wsdl/StudentService.wsdl");
        	url = new URL("http://localhost:8080/student-soap-web-service/wsdl/StudentService.wsdl");
     ...
     */
    @WebEndpoint(name = "StudentService")
    public StudentService getStudentService() {
        return super.getPort(new QName("http://sks.com", "StudentService"), StudentService.class);
    }
     ...
     */
    @WebEndpoint(name = "StudentService")
    public StudentService getStudentService(WebServiceFeature... features) {
        return super.getPort(new QName("http://sks.com", "StudentService"), StudentService.class, features);
    }
